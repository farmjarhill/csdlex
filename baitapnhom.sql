...
values ('MB291HĐ',N'Chi nhánh Hà Đông','7000000000000 ',N'Q.Hà Đông, Hà Nội')
insert CHINHANH(MaCN,TenCN,Taisan,Diachi)
...
VALUES ('1268443',N'Chứng chỉ tiền gửi ghi danh','06/18/2022','8.4','18','MB291HĐ','291DN003')
INSERT CHUNGCHI(SoSR,TenChungChi,NgayPH,Laisuat,Thoihan,MaCN,MaKH)
...
INSERT GIAODICH(MaGD,LoaiGD,NgayGD,NguoiGD,SotienGD,MaCN)
VALUES ('291TG063',N'Gửi tiền vào tài khoản','08/17/2022',N'Nguyễn Thị Hồng','18000000','MB291HĐ')
INSERT GIAODICH(MaGD,LoaiGD,NgayGD,NguoiGD,SotienGD,MaCN)
VALUES ('291TG095',N'Vay tiền','08/19/2022',N'Lê Việt Anh','500000000','MB291HĐ')



-- BẢNG KHOANVAY
INSERT KHOANVAY(MaKV,LoaiVay,Laisuat,MaKH)
...
-- BẢNG KHOANGUI
INSERT KHOANGUI(MaKG,LoaiGui,Laisuat,MaKH)
...
VALUES ('291036716','05/14/2019','19000000','291M03','MB291HĐ')
INSERT TAIKHOAN(MaTK,NgayMo,SoDuTK,MaKH,MaCN)
VALUES ('291036712','04/26/2020','27000000','291F06','MB291HĐ')
INSERT TAIKHOAN(MaTK,NgayMo,SoDuTK,MaKH,MaCN)
